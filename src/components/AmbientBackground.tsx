  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, hsl(265 80% 55% / 0.08), transparent 65%)",
          filter: "blur(70px)",
        }}
      />

      {/* Emerald tint — center, very low opacity */}
      <div
        className="absolute top-1/3 left-1/3 h-[55vw] w-[55vw] rounded-full animate-blob-drift-3 will-change-transform"
        style={{
          background:
            "radial-gradient(circle at center, hsl(var(--primary) / 0.05), transparent 70%)",
          filter: "blur(80px)",
        }}
      />
